...
class WebsitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create website" do
    assert_difference('Website.count') do
      post websites_url, params: { website: { address: @website.address, agent_name: @website.agent_name, contact: @website.contact, name: @website.name } }
    end
  ...
  test "should update website" do
    patch website_url(@website), params: { website: { address: @website.address, agent_name: @website.agent_name, contact: @website.contact, name: @website.name } }
